...
//                </View>
//            </View>
//            <View style={[styles.box, { height: 480 }]} >
//                <View style={[styles.box0, { height: 0 }]} >
//                    <Text style={styles.table} break>
//                        -----
//      </Text>
//                    <Text style={styles.table} break>
//                        1.
//      </Text>
//                </View>
//                <View style={[styles.box1, { height: 0 }]} >
//                    <Text style={styles.table} break>
//                        Nome
//      </Text>
//                    <Text style={styles.table} break>
...
//      </Text>
//                </View>
//                <View style={[styles.box2, { height: 0 }]} >
//                    <Text style={styles.table} break>
//                        Quantidade
//      </Text>
//                    <Text style={styles.table} break>
...
//      </Text>
//                </View>
//                <View style={[styles.box3, { height: 0 }]} >
//                    <Text style={styles.table} break>
//                        Posologia
//      </Text>
//                    <Text style={styles.table} break>
//                        2 comprimidos de 2 em 2 horas
//      </Text>
//                </View>
//                <View style={[styles.box4, { height: 0 }]} >
//                    <Text style={styles.table} break>
//                        Código
//      </Text>
//                </View>
